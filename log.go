...
func New(w io.Writer) Logger {
	...
	return Logger{w: lw, level: TraceLevel, npl: strings.EqualFold(os.Getenv("ZEROLOG_NO_HOOKS"), "true")}
}
...
func (l *Logger) newEvent(level Level, done func(string)) *Event {
	...
	e.ch = l.hooks
	e.ctx = l.ctx
	if l.printLevel() && level != NoLevel && LevelFieldName != "" {
